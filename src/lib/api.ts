...
export function pricesFetcher([itemIds, region, cities = CITIES]: [
	...
	return fetch(
		`https://${SERVERS[region].e}.albion-online-data.com/api/v2/stats/prices/${ids}?locations=${locations}&qualities=1`,
